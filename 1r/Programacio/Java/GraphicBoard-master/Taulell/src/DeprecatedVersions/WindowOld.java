...
public class WindowOld extends JFrame {
	...
	/*
	 * TODO Posar opci� de musica i opci� de carregarli un jPanel de pantalla d'intro?
	 */

	private BoardOld board;
	private BoardOld board2;
	private Field field;
	...
	public WindowOld(BoardOld t) {
		board = t;
		init();
	}
	
	public WindowOld(BoardOld t, BoardOld t2) {
		board = t;
		board2 = t2;
		secondBoard = true;
		init();
	...
	private void renew() {
		...
		if (debugLabel){
			...
			JLabel debugm = new JLabel("Ultima casella premuda amb el ratol� "+board.getMouseRow()+", "+board.getMouseCol());
