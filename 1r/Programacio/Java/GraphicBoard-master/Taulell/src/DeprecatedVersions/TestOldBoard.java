...
/**
 * Test Petita demostraci� de representacions possibles. s'avan�a donant enter a
 * la consola
 *
 */

public class TestOldBoard {

	public static void main(String[] args) {
		BoardOld t = new BoardOld();
		WindowOld f = new WindowOld(t);
		...
		System.out.println("pots provar de clicar la casella que vulguis o de apretar les tecles que vulguis i es mostraran (per mostrar la casella clicada tamb� has d'apretar una tecla qualsevol."
		...
		BoardOld t2 = new BoardOld();
		WindowOld f2 = new WindowOld(t, t2);
		t.delOverdraw();
		t.setActcolors(true);
		t.setActsprites(false);
		t.setActtext(false);
