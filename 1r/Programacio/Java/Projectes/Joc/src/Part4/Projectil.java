...
public class Projectil extends PhysicBody{
	...
	public void onCollisionEnter(Sprite sprite) {
		System.out.println("proj coll with " + sprite.name); //imprimeix objecte si ha colisionat
        if(sprite instanceof Disparable && !(sprite instanceof Nau)) { //es pot fer un instanceof a l'interfície, no només la classe
            Disparable d = (Disparable) sprite; //casteig a disparable
            d.danyarNau(); //cridem a danyar
