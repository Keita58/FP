...
<html lang="cat">
    ...
    <body class="bg-gradient-to-br from-cyan-500 to-green-600 h-dvh text-white">
        ...
        <div class="flex flex-col justify-center text-center font-bold p-20">
            <h2 class="text-xl p-20">Per a nous clients, registreu-vos aquí -> <a href="client/insert" class="hover:text-yellow-400 hover:bg-black rounded"><span class="hover:m-2">Registre</span></a></h2>
