...
@Component({
  selector: 'app-get-cartes-jugador',
  standalone: false,

  templateUrl: './get-cartes-jugador.component.html',
  styleUrl: './get-cartes-jugador.component.css'
})
export class GetCartesJugadorComponent {
  message!: string;
  jugador : number = 0;
  jugadors !: Jugadors;
  ...
  resposta(){
    this.connect.getCartesJugador(this.jugador).subscribe(res => {
      this.message = "";
      console.log(res);
